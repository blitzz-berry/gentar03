...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Galeri</h1>
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="flex items-center">
                        <label class="flex items-center cursor-pointer">
                            ...
                            <input type="checkbox" name="aktif" value="1" class="form-checkbox" {{ old('aktif', $galeri->aktif) ? 'checked' : '' }}>
                ...
                <div class="mb-4">
                    ...
                    @if($galeri->tipe === 'image')
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $galeri->path_file) }}" alt="{{ $galeri->judul }}" class="h-32 object-cover rounded">
                        </div>
                    @elseif($galeri->tipe === 'video')
                        <div class="mb-2">
                            <video controls class="h-32 object-cover rounded">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('file') border-red-500 @enderror"
                           ...
                           type="file"
                           name="file">
                    <p class="text-gray-600 text-xs italic mt-2">Format: jpeg, png, jpg, gif, mp4, mov, avi (Max: 100MB). Kosongkan jika tidak ingin mengganti file.</p>
                    @error('file')
                        <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                    @enderror
                </div>
